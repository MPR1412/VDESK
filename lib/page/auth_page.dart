  ...
  Widget buildEmailField() {
    ...
    return TextFormField(
      ...
      validator: (value) {
        ...
        final pattern = r'(^[\d]{5}[A-Za-z]12[A-Za-z0-9]{2}@bvrit.ac.in$)';
        //final pattern1=r'(^[\d]{5}[A-Za-z]05[A-Za-z0-9]{2}@bvrit.ac.in$)';
        final regExp = RegExp(pattern);

        if (!regExp.hasMatch(value)) {
          return 'This email is not valid for your department';
        }
        else {
          return null;
        }
