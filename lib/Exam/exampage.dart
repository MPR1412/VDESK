...
import 'package:vdesk/clickoncontact/Examcontacts.dart';
...
class exampage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'Examination Branch', /*style:TextStyle(color:Colors.black)*/
        ),
          ...
          children: <Widget>[
            ...
            Card(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => ExamNotice()));
                },
                splashColor: Colors.lightBlueAccent,
                child: Center(
                  child: Column(
...
class _TimeTable extends State<TimeTable> {
  ...
  List<QueryDocumentSnapshot> examnotice;

  final CollectionReference collectionReference =
  FirebaseFirestore.instance.collection("examnotice");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: examnotice != null
            ? new StaggeredGridView.countBuilder(
          padding: const EdgeInsets.all(9.0),
          crossAxisCount: 1,
          itemCount: examnotice.length,
          itemBuilder: (context, i) {
            // Image.network(url);
            String imgPath= examnotice[i].get('url');
...
class ExamNotice extends StatefulWidget {
  _ExamNotice createState() => new _ExamNotice();
}

class _ExamNotice extends State<ExamNotice> {
  StreamSubscription<QuerySnapshot> subscription;
  List<QueryDocumentSnapshot> examnotice;
