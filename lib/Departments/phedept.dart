...
class phedept extends StatelessWidget {
  @override
          ...
          children: <Widget>[
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => aboutphe()));
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => pheNotice()));
                },
                splashColor: Colors.lightBlueAccent,
                child: Center(
                  child: Column(
...
class aboutphe extends StatelessWidget {
  const aboutphe({Key key}) : super(key: key);
...
class pheNotice extends StatefulWidget {
  _pheNotice createState() => new _pheNotice();
}

class _pheNotice extends State<pheNotice> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;
