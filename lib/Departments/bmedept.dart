...
class bmedept extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'BIOMEDICAL ENGINEERING DEPARTMENT', /*style:TextStyle(color:Colors.black)*/
        ),
          ...
          children: <Widget>[
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => aboutbme()));
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => bmeNotice()));
                },
                splashColor: Colors.lightBlueAccent,
                child: Center(
                  child: Column(
...
class aboutbme extends StatelessWidget {
  const aboutbme({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'BIOMEDICAL DEPARTMENT', /*style:TextStyle(color:Colors.black)*/
        ),
        backgroundColor: Colors.black,
        elevation: 10.0,
      ),
...
//Start of Notice
class bmeNotice extends StatefulWidget {
  _bmeNotice createState() => new _bmeNotice();
}

class _bmeNotice extends State<bmeNotice>{
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;
