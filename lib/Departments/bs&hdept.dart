...
class bshdept extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'BASIC SCIENCES and HUMANITY DEPARTMENT', /*style:TextStyle(color:Colors.black)*/
        ),
          ...
          children: <Widget>[
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => aboutbsh()));
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => bshNotice()));
                },
                splashColor: Colors.lightBlueAccent,
                child: Center(
                  child: Column(
...
class aboutbsh extends StatelessWidget {
  const aboutbsh({Key key}) : super(key: key);
...
//Start of Notice
class bshNotice extends StatefulWidget {
  _bshNotice createState() => new _bshNotice();
}

class _bshNotice extends State<bshNotice> {
  StreamSubscription<QuerySnapshot> subscription;
  List<DocumentSnapshot> timeTable;
